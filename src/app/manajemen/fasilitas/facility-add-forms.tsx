...
import { createFacility, createFacilityCategory } from "./actions";
...
export function AddAssetForm({
  ...
  return (
    ...
    >
      ...
      <Button type="submit" disabled={facilityCategories.length === 0} className="w-full">
...
export function AddCategoryForm({
  ...
  return (
    <form 
      action={async (formData) => {
        await createFacilityCategory(formData);
        onSuccess?.();
      }} 
      className="grid gap-4"
    >
      ...
      <Button type="submit" variant="default" className="w-full bg-emerald-600 hover:bg-emerald-500">
